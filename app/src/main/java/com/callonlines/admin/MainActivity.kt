...
import com.callonlines.admin.databinding.ActivityMainBinding
...
class MainActivity : AppCompatActivity() {
    ...
    override fun onCreate(savedInstanceState: Bundle?) {
        ...
        setTheme(R.style.Theme_CallOnLinesAdmin)
    ...
    private fun configureWebView() {
        with(webView.settings) {
            ...
            userAgentString = userAgentString + " CallOnLinesAdmin/1.0"
        ...
        webView.webViewClient = object : WebViewClient() {
            ...
            override fun onPageFinished(view: WebView?, url: String?) {
                ...
                val urlStr = url ?: ""
                val isLogin = urlStr.contains(LOGIN_URL_HINT, ignoreCase = true)
    ...
    companion object {
        private const val START_URL = "https://callonlines.com/root_login.php"
        private const val LOGIN_URL_HINT = "root_login.php"
...
class SavedCreds(context: Context) {
    ...
    private companion object {
        const val PREF_FILE = "callonlines_admin_creds"
